...
//		
//		//add Previous Days
//		int preDayValue = preTotalDays - startDayIndex;
//		for(int i = 0; i < startDayIndex; i++) {
//			dayButtons[i].setText(Integer.toString(preDayValue));
//			dayButtons[i].setForeground(Color.LIGHT_GRAY);
//			preDayValue++;
//		}
//		
//		//add Current Days
//		int index = startDayIndex - 1;
//		for(int i = 1; i <= curTotalDays; i++) {
//			index++;
//			dayButtons[index].setText(Integer.toString(i));
...
//		int copyIndex = index;
//		index++;
//		for (int i = 1; i <= dayButtons.length - copyIndex - 1; i++) {
//			dayButtons[index].setText(Integer.toString(i));
